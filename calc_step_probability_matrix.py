...
def main():
    ...
    # 
    """
    #run_configurations('relative_target'       , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('fixed_target'          , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    run_configurations('fixed_target_entrance' , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets'           , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets1'          , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets2'          , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets_probe2'    , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets_probe3'    , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets_probe2'    , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , keep_between_targets=True, **config_param)
    #run_configurations('two_targets_probe3'    , clear_output_directory, omit_mice=None     , force_calc_separate_trials=True , out_dir_suffix=''       , keep_between_targets=True, **config_param)

    #run_configurations('two_targets'           , clear_output_directory, omit_mice=omit_mice, force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets1'          , clear_output_directory, omit_mice=omit_mice, force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets2'          , clear_output_directory, omit_mice=omit_mice, force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets_probe2'    , clear_output_directory, omit_mice=omit_mice, force_calc_separate_trials=True , out_dir_suffix=''       , **config_param)
    #run_configurations('two_targets_probe2'    , clear_output_directory, omit_mice=omit_mice, force_calc_separate_trials=True , out_dir_suffix=''       , keep_between_targets=True, **config_param)

    #run_configurations('relative_target'       , clear_output_directory, omit_mice=None     , force_calc_separate_trials=False, out_dir_suffix='1stage' , **config_param_1stage)
    #run_configurations('fixed_target'          , clear_output_directory, omit_mice=None     , force_calc_separate_trials=False, out_dir_suffix='1stage' , **config_param_1stage)
    run_configurations('fixed_target_entrance' , clear_output_directory, omit_mice=None     , force_calc_separate_trials=False, out_dir_suffix='1stage' , **config_param_1stage)
    #run_configurations('two_targets'           , clear_output_directory, omit_mice=None     , force_calc_separate_trials=False, out_dir_suffix='1stage' , **config_param_1stage)
    #run_configurations('two_targets1'          , clear_output_directory, omit_mice=None     , force_calc_separate_trials=False, out_dir_suffix='1stage' , **config_param_1stage)
    #run_configurations('two_targets2'          , clear_output_directory, omit_mice=None     , force_calc_separate_trials=False, out_dir_suffix='1stage' , **config_param_1stage)
    #run_configurations('two_targets'           , clear_output_directory, omit_mice=omit_mice, force_calc_separate_trials=False, out_dir_suffix='1stage' , **config_param_1stage)
    #run_configurations('two_targets1'          , clear_output_directory, omit_mice=omit_mice, force_calc_separate_trials=False, out_dir_suffix='1stage' , **config_param_1stage)
    #run_configurations('two_targets2'          , clear_output_directory, omit_mice=omit_mice, force_calc_separate_trials=False, out_dir_suffix='1stage' , **config_param_1stage)
...
def run_configurations(experiment,clear_output_directory,out_dir_suffix='',omit_mice=None,force_calc_separate_trials=False,keep_between_targets=False,mouse_part=None,L=None,prob_calc=None,start_from_zero=None,n_stages=None,stop_at_food=None):
    ...
    valid_experiments = ['relative_target','fixed_target','fixed_target_entrance','two_targets','two_targets1','two_targets2','two_targets_probe2','two_targets_probe3']
    ...
    if misc.exists(omit_mice) and (len(omit_mice[experiment])>0):
        ...
        input_tracks = remove_mice_from_trials(input_tracks,omit_mice[experiment])
