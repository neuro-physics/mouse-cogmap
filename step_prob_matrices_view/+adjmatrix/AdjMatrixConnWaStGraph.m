classdef (Sealed) AdjMatrixConnWaStGraph < adjmatrix.AdjMatrixFromNetX
    methods
        function this = AdjMatrixConnWaStGraph(params, loadOnInit, delAfterLoad)
            ...
            this = this@adjmatrix.AdjMatrixFromNetX('connected_watts_strogatz_graph', params, loadOnInit, delAfterLoad);
        end
    end
